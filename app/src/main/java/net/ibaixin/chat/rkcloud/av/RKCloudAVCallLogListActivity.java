    ...
    private void initUI() {
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                String[] items = new String[] { getString(R.string.rkcloud_av_calllog_context_audiodial),
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        switch (which) {
                        case 0:// 发起语音呼叫
                            mAVManager.dial(RKCloudAVCallLogListActivity.this, calllog.getOtherAccount(),null, false);
                            break;

                        case 1:// 发起视频通话
                            mAVManager.dial(RKCloudAVCallLogListActivity.this, calllog.getOtherAccount(),null, true);
                            break;
                        ...
                        case 3:
                            // 删除所有通话记录
                            new AlertDialog.Builder(RKCloudAVCallLogListActivity.this).setTitle(R.string.rkcloud_av_tip)
                                    .setMessage(R.string.rkcloud_av_calllog_clear_confirm)
                                    .setNegativeButton(R.string.rkcloud_av_btn_cancel, null).setPositiveButton(
                                            R.string.rkcloud_av_btn_confirm, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
