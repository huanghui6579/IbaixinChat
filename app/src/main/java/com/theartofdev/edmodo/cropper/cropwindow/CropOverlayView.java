...
//            canvas.drawRect(r, t, bitmapRect.right, b, mBackgroundPaint);
        	//画上面的矩形
            canvas.drawRect(left, top, right, t, mBackgroundPaint);
            //画下面的矩形
            canvas.drawRect(left, b, right, bottom, mBackgroundPaint);
            //画左边的矩形
            canvas.drawRect(left, t, l, b, mBackgroundPaint);
            //画右边的矩形
            canvas.drawRect(r, t, right, b, mBackgroundPaint);
        } else {
